...
resource "aws_iam_policy" "lambda" {
  name        = "BRONXAWSLambdaBasicExecutionRolePolicy"
  path        = "/"
  ...
  policy = <<EOF
{
    ...
    "Statement": [
        ...
        {
          "Action": "iam:PassRole",
          "Resource": ["arn:aws:iam::284165992806:role/EMR_DefaultRole",
                       "arn:aws:iam::284165992806:role/EMR_EC2_DefaultRole"],
          "Effect": "Allow"
        }
    ]
}
